...
struct WEXDebugger {
    ...
    static func createEvent(eventName: String,
        ...
        event[WEDConstants.KEY_EVENT_TIME] = WEXCoreUtils.getCurrentFormattedTime()
        ...
        systemData["sdk_id"] = 3
        if let sdkVersion = userDefaultsData.string(forKey: WEDConstants.WEX_SDK_VERSION) as? String, let intValue = Int(sdkVersion) {
    ...
    private static func sendEvents(_ events: [[String: Any]],
        ...
        guard let defaults = WEXCoreUtils.getSharedUserDefaults(), let urlString = defaults.string(forKey: WEDConstants.KEY_DEBUGGER_EVENT_SYNC_URL) else {
            return
        }
...
public class WEXLogProcessor: NSObject {
    public static func logReceivedNotification(loglevel: WEGLogLevel, message: Any, notification: UNNotificationContent?){
        ...
        let tags = WEGMetadataBuilder.create()
            ...
            .addTag(WEConstants.WE_CONTENT_EXTENSION, metadata: [loglevel.description :[WEDConstants.KEY_SDK_VERSION: WEConstants.WEX_CONTENT_EXTENSION_VERSION, WEDConstants.KEY_MESSAGE:message]])
            .build()
    ...
    public static func logImageDownloadingFailed(loglevel: WEGLogLevel, message: Any,notification: UNNotificationContent?){
        ...
        let tags = WEGMetadataBuilder.create()
            ...
            .addTag(WEConstants.WE_CONTENT_EXTENSION, metadata: [:])
            .build()
    ...
    public static func logtrackEvent(loglevel: WEGLogLevel, event: Any, eventValue: [String: Any]?){
        ...
        let tags = WEGMetadataBuilder.create()
            ...
            .addTag(WEGDebugTags.campaign_Id, metadata: [loglevel.description : campaign_id])
            .addTag(WEConstants.WE_CONTENT_EXTENSION, metadata: [loglevel.description :[WEDConstants.KEY_SDK_VERSION: WEConstants.WEX_CONTENT_EXTENSION_VERSION, WEDConstants.KEY_MESSAGE:event]])
            .build()
